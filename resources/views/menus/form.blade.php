...
@section('title', isset($result) ? 'Edit Menu' : 'Create Menu')
        ...
        <div class="container-fluid">
            <div class="page-header-content">
                <h1 class="page-header-title">
                    ...
                    <span>{{ isset($result) ? 'Edit Menu' : 'Create Menu' }}</span>
                </h1>
                <div class="page-header-subtitle">
                    Dynamic form component to make it easier for user to {{ isset($result) ? 'Edit' : 'Create' }} user data
                </div>
            </div>
        </div>
    </div>
                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header">
                            {{ isset($result) ? "Edit $result->name Menu" : 'Create new Menu' }}
                        </div>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        {{-- <div class="form-group">
                                            ...
                                            <input class="form-control" id="photo" name="photo" type="file"
                                                value="{{ old('photo', isset($result) ? $result->photo : '') }}" />
                                        </div> --}}
                                        ...
                                        <div class="form-group" style="margin-bottom: 1.5rem;">
                                            <label for="photo" style="font-weight: 600; color: #495057;">Menu</label>
                                            <input class="form-control" id="photo" name="photo" type="file"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="description" name="description" rows="3"
                                                placeholder="Enter menu description">{{ old('description', isset($result) ? $result->description : '') }}</textarea>
                                        </div>
