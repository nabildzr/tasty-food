                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center">
                                    <h3 class="font-weight-light my-4">Forgot Password</h3>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="{{ route('user.forgot-password') }}">
                                        ...
                                        <div
                                            ...
                                            <a class="small" href="login">Return to login</a><button
                                                class="btn btn-primary" type="submit">Reset Password</button>
                                        </div>
                                    </form>
                                </div>
