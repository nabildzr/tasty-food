    ...
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('users.create') }}" class="d-block">
                    <button class="btn btn-primary ml-auto">Create new User</button>
                </a>
            </div>
                            ...
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-datatable btn-icon btn-transparent-dark" title="Delete" data-toggle="modal" data-target="#deleteUserModal{{ $user->id }}"><i data-feather="trash-2"></i></button>
                                    </td>
                                </tr>


                                <div class="modal fade" id="deleteUserModal{{ $user->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="deleteUserModalTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteUserModalTitle">Delete
                                                    {{ $user->name }} Role</h5>
