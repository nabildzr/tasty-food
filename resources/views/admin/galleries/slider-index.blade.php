        ...
        <div class="container-fluid">
            <div class="page-header-content">
                <h1 class="page-header-title">
                    ...
                    <span>Slider Galleries</span>
                </h1>
                <div class="page-header-subtitle">
                    Manage your slider galleries and their images from this page.
                </div>
            </div>
        </div>
    </div>
    <div class="container-fluid mt-n10">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <p class="mb-0">Slider Galleries Datatables</p>
                <a href="{{ route('galleries.slider.create') }}" class="d-block">
                    <button class="btn btn-primary ml-auto">Create new Slider Gallery</button>
                </a>
            </div>
                        ...
                        <tbody>
                            @forelse ($galleries as $gallery)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('galleries.slider.edit', $gallery->id) }}">
                                        ...
                                        <button class="btn btn-datatable btn-icon btn-transparent-dark" title="Delete"
                                            data-toggle="modal" data-target="#deleteSliderGallery{{ $gallery->id }}"><i
                                                data-feather="trash-2"></i></button>
                                    </td>
                                </tr>


                                <div class="modal fade" id="deleteSliderGallery{{ $gallery->id }}" tabindex="-1"
                                    role="dialog" aria-labelledby="deleteSliderGalleryTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteSliderGalleryTitle">Delete Slider
                                                    Gallery</h5>
                                                <button class="close" type="button" data-dismiss="modal"
                                                    aria-label="Close"><span aria-hidden="true">×</span></button>
                                            </div>
                                            <div class="modal-body">Are you sure for deleting this Slider Gallery?</div>
                                            <div class="modal-footer">
                                                <button class="btn btn-secondary" type="button"
                                                    data-dismiss="modal">Close</button>

                                                <form action="{{ route('galleries.slider.delete', $gallery->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
