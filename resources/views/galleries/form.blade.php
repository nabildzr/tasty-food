...
@section('title', isset($result) ? 'Edit Gallery' : 'Create Gallery')
        ...
        <div class="container-fluid">
            <div class="page-header-content">
                <h1 class="page-header-title">
                    ...
                    <span>{{ isset($result) ? 'Edit Gallery' : 'Create Gallery' }}</span>
                </h1>
                ...
                <div id="default">
                    <div class="card mb-4">
                        <div class="card-header">
                            {{ isset($result) ? "Edit $result->id Gallery" : 'Create Gallery' }}
                        </div>
